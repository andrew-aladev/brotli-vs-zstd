...
stats = get_script_stats pathes, method(:brotli_compress), method(:brotli_decompress)
...
stats = get_script_stats pathes, method(:zstd_compress), method(:zstd_decompress)
